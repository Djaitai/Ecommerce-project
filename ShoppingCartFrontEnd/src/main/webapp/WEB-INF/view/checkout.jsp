			...
			<div class="col-xs-6 jumbotron">
					...
					<div class="well" style="width: 100%">
						<form action="${pageContext.request.contextPath}/invoiceprocess"
							...
							<c:forEach var="c" items="${cart}">
								<c:set var="srk2"
									value="${srk2 + c.price * c.quantity}"></c:set>
             ...
             <label>Email</label> &nbsp;    <input type="text"id="emailid"  value="${user.id}"  style="width:70%" disabled><br><br>
              ...
              <label style="width:70%">${srk2}</label><br><br> --%>
							...
							<div class="well">
								<label>Payment</label><br> <select name="payment">
								...
								<input type="text" name="cardnum"
									placeholder="Enter your card number" style="width: 70%"><br>
								<br> <input type="text" name="name"
									placeholder="Name on the card"
									style="margin-bottom: 10px; width: 70%"><br>
								<div>
									<table>
										<tr>
										...
										<tr>
											<td colspan="2"><input type="number" min="1" max="12"
												name="month" placeholder="mm" style="width: 50px"> <input
												type="number" min="1" max="12" name="year" placeholder="yy"
												style="width: 50px"></td>
											<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
											<td>
